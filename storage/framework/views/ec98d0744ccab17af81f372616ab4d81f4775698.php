...
<div class="mainDiv" style="margin: 0px 100px">
    ...
    <div class="data_div">
        <?php $__currentLoopData = $allUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="card" style="margin-top: 30px; display: flex;" id="userForm<?php echo e($user->id); ?>">
                <div class="card-body">
                    <h5 class="card-title userName">Username: <?php echo e($user->name); ?></h5>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/pedromacedo/Desktop/pedroLBAW/2nd-delivery/lbaw2284/resources/views/pages/adminManageUsers.blade.php ENDPATH**/ ?>